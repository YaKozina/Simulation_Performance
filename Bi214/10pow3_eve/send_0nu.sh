...
OUT_BASE="/sps/nemo/scratch/ykozina/Falaise/tutorial/0nu/Bi214/10pow3_eve/jobs_done"
...
/sps/nemo/sw/redhat-9-x86_64/snsw/opt/falaise-5.1.2/bin/flsimulate \
    -c /sps/nemo/scratch/ykozina/Falaise/tutorial/0nu/Bi214/10pow3_eve/Simu_0nu_Bi214.conf \
    -o "$SIM_FILE"
