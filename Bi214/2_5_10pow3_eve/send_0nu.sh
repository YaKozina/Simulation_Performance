...
OUT_BASE="/sps/nemo/scratch/ykozina/Falaise/tutorial/0nu/Bi214/2_5_10pow3_eve/jobs_done"
OUT_DIR="$OUT_BASE/job_$INDEX"
RUNTIME_FILE="$OUT_BASE/runtime_raw.txt"

mkdir -p "$OUT_DIR"

SIM_FILE="$OUT_DIR/Simu_0nu_Bi214_${INDEX}.brio"
RECO_FILE="$OUT_DIR/Reco_0nu_Bi214_${INDEX}.brio"

start_time=$(date +%s)

/sps/nemo/sw/redhat-9-x86_64/snsw/opt/falaise-5.1.2/bin/flsimulate \
    -c /sps/nemo/scratch/ykozina/Falaise/tutorial/0nu/Bi214/2_5_10pow3_eve/Simu_0nu_Bi214.conf \
    -o "$SIM_FILE"
